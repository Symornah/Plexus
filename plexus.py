...
#defining a class circle containg all the functions regarding the making of circles
class Circle:
...
#function to define the color of the vector drawn from one circle to another
    ...
    while running:
        ...
        for i in circles.connect_circles():
            ...
            if distance < max_distance:
                pg.draw.line(screen, color(distance, max_distance), start_pos=i[0], end_pos=i[1], width=4)
        # Draw circles
        for i in circles.circles:
            pg.draw.circle(screen, RED, center=i[:2], radius=5)
